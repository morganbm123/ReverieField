...
void fsr1StateChanges() {
  ...
  if (fsr1State == 1 || fsr1State == 2) {
    ...
    //if the finger isn't putting maximum pressure then the pulsing is mapped to the fsr
    if (fsr1Reading > 200 && fsr1Reading < 700 && !bulb4Dim ) {
      CH4 = 128 - fsr1Reading / 8;
    }
    //if the finger is putting max pressure then the pulsing becomes automated
    if (fsr1Reading >= 700 && bulb4Dim == false) {
...
void fsr2StateChanges() {
  ...
  if (fsr2State == 0 || fsr2State == 1 || fsr2State == 2) {
    ...
    //if the finger isn't putting maximum pressure then the pulsing is mapped to the fsr
    if (fsr2Reading > 200 && fsr2Reading < 700 && !bulb11Dim ) {
      CH11 = 128 - fsr2Reading / 8;
    }
    //if the finger is putting max pressure then the pulsing becomes automated
    if (fsr2Reading >= 700 && bulb11Dim == false) {
      bulb11Dim = true;
      ptime = millis();
    }
  ...
  if (fsr2State == 2) {
    ...
    //if the finger isn't putting maximum pressure then the pulsing is mapped to the fsr
    if (fsr2Reading > 200 && fsr2Reading < 700 && !bulb5Dim ) {
      CH5 = 128 - fsr2Reading / 8;
    }
    //if the finger is putting max pressure then the pulsing becomes automated
    if (fsr2Reading >= 700 && bulb5Dim == false) {
      bulb5Dim = true;
      ptime = millis();
    }
...
void fsr3StateChanges() {
  ...
  if (fsr3State == 0 || fsr3State == 1 || fsr3State == 2) {
    ...
    //if the finger isn't putting maximum pressure then the pulsing is mapped to the fsr
    if (fsr3Reading > 200 && fsr3Reading < 700 && !bulb15Dim ) {
      CH15 = 128 - fsr3Reading / 8;
    }
    //if the finger is putting max pressure then the pulsing becomes automated
    if (fsr3Reading >= 700 && bulb15Dim == false) {
      bulb15Dim = true;
      ptime = millis();
    }
...
void fsr4StateChanges() {
  ...
  if (fsr4State == 0 || fsr4State == 1 || fsr4State == 2) {
    ...
    //if the finger isn't putting maximum pressure then the pulsing is mapped to the fsr
    if (fsr4Reading > 200 && fsr4Reading < 700 && !bulb7Dim ) {
      CH7 = 128 - fsr4Reading / 8;
    }
    //if the finger is putting max pressure then the pulsing becomes automated
    if (fsr4Reading >= 700 && bulb1Dim == false) {
      bulb1Dim = true;
      ptime = millis();
    }
  ...
  if (fsr4State == 2) {
    ...
    //if the finger isn't putting maximum pressure then the pulsing is mapped to the fsr
    if (fsr4Reading > 200 && fsr4Reading < 700 && !bulb3Dim ) {
      CH3 = 128 - fsr4Reading / 8;
    }
    //if the finger is putting max pressure then the pulsing becomes automated
    if (fsr4Reading >= 700 && bulb3Dim == false) {
      bulb3Dim = true;
      ptime = millis();
    }
...
void fsr5StateChanges() {
  ...
  if (fsr5State == 0 || fsr5State == 1 || fsr5State == 2) {
    ...
    //if the finger isn't putting maximum pressure then the pulsing is mapped to the fsr
    if (fsr5Reading > 200 && fsr5Reading < 700 && !bulb6Dim ) {
      CH6 = 128 - fsr5Reading / 8;
    }
    //if the finger is putting max pressure then the pulsing becomes automated
    if (fsr5Reading >= 700 && bulb6Dim == false) {
      bulb6Dim = true;
      ptime = millis();
    }
  ...
  if (fsr5State == 2) {
    ...
    //if the finger isn't putting maximum pressure then the pulsing is mapped to the fsr
    if (fsr5Reading > 200 && fsr5Reading < 700 && !bulb8Dim ) {
      CH8 = 128 - fsr5Reading / 8;
    }
    //if the finger is putting max pressure then the pulsing becomes automated
    if (fsr5Reading >= 700 && bulb8Dim == false) {
      bulb8Dim = true;
      ptime = millis();
    }
